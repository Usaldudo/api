...
# SQLALCHEMY_DATABASE_URL = "postgresql+psycopg://postgres:root@localhost:5432/fastapi_test"
SQLALCHEMY_DATABASE_URL = f"postgresql+psycopg://{settings.database_username}:"\
    f"{settings.database_password}@{settings.database_hostname}:{settings.database_port}/{settings.database_name}_test"
